...
const EditGrowRoomPostPage = ({ postId }) => {
    ...
    useEffect(() => {
      const fetchData = async () => {
        try {
        console.log('postId', location.state.postId);  // location.state.postId를 사용
        const response = await GrowRoomPostApi.getGrowRoomPosts(location.state.postId);
          setFormData(response);
          console.log('edit page에서 서버 응답보기', response);
        } catch (error) {
  ...
  const handleSubmitButtonClick = async () => {
    ...
    try {
      console.log('formData.growRoomId',formData.growRoomId)
      await GrowRoomPostApi.updateGrowRoomPost(formData.growRoomId, getDefaultBody());
...
export default EditGrowRoomPostPage;
