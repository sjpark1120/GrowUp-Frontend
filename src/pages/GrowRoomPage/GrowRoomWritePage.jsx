...
const itmedia = ['스터디', '인공지능 ', '데이터 분석', '사이버 보안', '모바일 앱', '웹 개발',
  '소셜 미디어', '클라우드 컴퓨팅', '게임 개발', '블록 체인']
const sports = ['축구 ', '농구 ', '식단 ', '필라테스 ', '스포츠 심리학', '헬스 ',
  '물리치료', '레크레이션 ', '스포츠 체육학', '수영']
const study = ['학교 시험', '토익 / 토플', '스피치', '기획', '한국사', '편집',
  '자격증', '수능', '컴퓨터활용능력 ', '언어']
const art = ['시각디자인 ', '회화 ', '조소 ', '패션 ', '취미 미술', '일러스트레이션 ',
  '캘리그라피 ', '뜨개질 ', '십자수 ', '소묘']
const project = ['비즈니스 아이디어', '코딩 대회', '연구 프로젝트', '디자인 공모전', '스타트업 창업',
  '기획 공모전', '봉사 프로젝트', '문학 작품 공모전', '사진 공모전', '음악 경연']
    ...
    <all>
      <WriteForm>
        ...
        <Group1>
          <CategoryForm>
            <h2>모집 구분</h2>
            <Dropdown title="스터디/챌린지/프로젝트" optionsMap={select_category} />
          </CategoryForm>
          <CategoryForm>
            <h2>모집 인원</h2>
            <Dropdown title="인원미정 ~ 10명 이상" optionsMap={people} />
          </CategoryForm>
        </Group1>
        <Group1>
          <CategoryForm>
          ...
          <CategoryForm>
            <h2>진행 기간</h2>
            <Dropdown title="기간미정 ~ 6개월 이상" optionsMap={progressPeriod} />
          </CategoryForm>
        </Group1>
      </WriteForm>
      ...
      <WriteForm>
        ...
        <Group1>
          <CategoryForm>
            <h2>IT미디어</h2>
            <Dropdown title="가상현실 / 인공지능 / 데이터분석 / 사이버보안/..." optionsMap={itmedia} />
          </CategoryForm>
          <CategoryForm>
            <h2>스포츠/헬스</h2>
            <Dropdown title="축구 / 농구 / 식단 / 필라테스 / 스포츠 심리학/..." optionsMap={sports} />
          </CategoryForm>
        </Group1>
        <Group1>
          <CategoryForm>
            <h2>공부/자격증</h2>
            <Dropdown title="학교 시험 / 토익 / 토플/  스피치 / 기획 /..." optionsMap={study} />
          </CategoryForm>
          <CategoryForm>
            <h2>미술/디자인</h2>
            <Dropdown title="시각디자인 / 회화 / 조소 / 패션 / 취미 미술/..." optionsMap={art} />
          </CategoryForm>
        </Group1>
        ...
        <Group1>
          <CategoryForm>
            <h2>공모전/프로젝트</h2>
            <Dropdown title="비즈니스 아이디어 / 코딩 대회 / 연구 프로젝트/..." optionsMap={project} />
          </CategoryForm>
          <CategoryForm>
            <h2>기타 기입</h2>
            <input type="text" placeholder="카테고리를 직접 입력해 주세요" />
          </CategoryForm>
        </Group1>
      </WriteForm>
      <WriteForm>
