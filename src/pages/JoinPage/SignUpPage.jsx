        ...
        <form onSubmit={onSubmit}>
          ...
          <SignUpLabel htmlFor="nickname">
            ...
            {nicknameTouched && nicknameError && (
              <ErrorText>ⓘ 2글자 이상 10글자 미만으로 작성해 주세요.</ErrorText>
            )}
          </SignUpLabel>
          <SignUpInput
            id="nickname"
          ...
          <SignUpLabel htmlFor="email">
            ...
            {emailTouched && emailError && (
              <ErrorText>ⓘ 이메일이 올바르지 않습니다.</ErrorText>
            )}
          </SignUpLabel>
          <SignUpInput
            id="email"
          ...
          <SignUpLabel htmlFor="password">
            ...
            {passwordTouched && passwordError && (
              <ErrorText>
                ⓘ 최소 8자, 최대 20자, 영문자, 숫자 모두 포함되어야 합니다.
              </ErrorText>
            )}
          </SignUpLabel>
          <PasswordContainer>
            ...
            />
            <EyeIcon
              src={showPassword ? eye_green : eye}
          ...
          <SignUpLabel htmlFor="passwordcheck">
            ...
            {passwordCheckTouched && passwordCheckError && (
              <ErrorText>ⓘ 비밀번호가 동일하지 않습니다.</ErrorText>
            )}
          </SignUpLabel>
          <PasswordContainer>
            <SignUpInput
            ...
            />
            <EyeIcon
              src={showPasswordCheck ? eye_green : eye}
